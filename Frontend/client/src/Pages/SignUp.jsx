...
function SignUp() {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundImage: 'linear-gradient(to bottom right, #4facfe, #00f2fe)', color: 'black'}}>
    <div style={{ width: '400px', padding: '20px', backgroundColor: 'white', borderRadius: '10px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.5)' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <p style={{paddingTop:"10px"}}>Already an User? <Link to="/signin" >SignIn</Link> here.</p>
      </form>
    </div>
  </div>
